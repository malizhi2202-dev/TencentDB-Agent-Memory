...
import { EMPTY_AGENT_LLM, type AgentLlmConfig } from '@/services';
...
export default function CreateAgentDialog({
  ...
  const [llm, setLlm] = useState<AgentLlmConfig>(EMPTY_AGENT_LLM);
  ...
  return (
    <Modal visible caption={t('createAgent.caption')} size="l" onClose={onClose} disableEscape={busy}>
      <Modal.Body>
        ...
        <AgentLlmFields value={llm} onChange={setLlm} />
